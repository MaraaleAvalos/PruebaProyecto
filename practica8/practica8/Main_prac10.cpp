...
int main()
{
	...
	Model BotaDer((char*)"Models/Personaje/casapedorrax21.obj");
	//Model Puerta((char*)"Models/Personaje/puertax2.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		view = camera.GetViewMatrix();
		glm::mat4 model(1);
		tmp=model = glm::translate(model, glm::vec3(-60.0f, -45.0f, -140.0f));
		model = glm::scale(model, glm::vec3(0.080f, 0.080f, 0.080f));
		...
		//view = camera.GetViewMatrix();
		//glm::mat4 model(1);
		//model = glm::translate(model, glm::vec3(-70.0f, -30.0f, -120.0f));
		//model = glm::scale(model, glm::vec3(0.010f, 0.020f, 0.015f));
		////model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		//glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		/*view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-0.2f, -1.0f, -17.0f));
